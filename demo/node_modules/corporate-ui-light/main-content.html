...
<script src="polyfill/ie-polyfills.js"></script>
      ...
      ready: function(){
          var favicons = [{rel: "shortcut icon", href: "https://static.scania.com/resources/logotype/scania/favicon/favicon.ico"},
              ...
              { rel: "manifest", href: "https://static.scania.com/resources/logotype/scania/favicon/manifest.json"}
                  ...
                  styleContent = 'body { display: flex; flex-direction: column; } body[ks-primary-submenu-open] ' +
                          '.navbar.navbar-default .container-fluid {background-color: #f7f7f7;}' +
                          'body[ks-primary-submenu-open] .collapse.navbar-collapse {margin-bottom: 36px;background-color: #fff;}',
