  ...
  <template>
   <style>
     ...
     @media (min-width: 992px) {
         ...
         :host.sticky-header ::content .navbar-nav.navbar-right, :host[hidden].sticky-header ::content .navbar-nav.navbar-right {
             padding-right: 60px;
         }
     ...
     @media (max-width: 991px) {
         ...
         :host .navbar-default .navbar-header button {
             position: fixed;
             left: 23px;
             z-index: 1031;
         }

         :host .navbar-default .navbar-toggle {
             padding-left: 14px;
             padding-right: 14px
         }
     }
